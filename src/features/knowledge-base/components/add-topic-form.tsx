...
export function AddTopicForm() {
  ...
  const isStepValid = () => {
    ...
    switch (currentStep) {
      ...
      case 2:
        return (
          values.topicReasoning ||
          !errors.topicReasoning ||
          !values.topicReasoning
        );
      case 3:
        return (
          values.learningObjectives.length > 0 &&
          values.learningObjectives.every(
            (obj) => obj.title && obj.description,
          ) &&
            ...
            <div className='space-y-6 text-sm'>
              <div className='space-y-2'>
                ...
                <p className='text-xs text-muted-foreground'>
                  Give your learning topic a clear, descriptive name
                </p>
                {errors.topicTitle && (
              ...
              <div className='space-y-2'>
                ...
                />
                <p className='text-xs text-muted-foreground'>
                  Help us understand the scope and focus of your learning
                </p>
                {errors.topicDescription && (
            ...
            <div className='space-y-6 '>
              <div className='items-start gap-3 p-4 bg-cyan-50 rounded-lg border border-cyan-200 md:block hidden'>
                <div className='space-y-1'>
                  <p className='font-medium text-sm text-cyan-900'>
                    Why does motivation matter?
                  </p>
                  <p className='text-xs text-cyan-700'>
                    Understanding your &quot;why&quot; helps us create a more
                    personalized learning experience and keeps you motivated
            ...
            <div className='space-y-6 '>
              ...
              <div className='space-y-4 max-h-72 overflow-y-scroll'>
                {fields.map((field, index) => (
                  <Card
                    key={field.id}
                    className='p-4 border-2 border-dashed border-muted'
                  >
                    <div className='space-y-4'>
                      ...
                      <div className='space-y-2'>
                        ...
                        {errors.learningObjectives?.[index]?.title && (
                          <p className='text-sm text-destructive'>
                            {errors.learningObjectives[index]?.title?.message}
                          </p>
                        )}
                      </div>
                      ...
                      <div className='space-y-2'>
                        <Label
                          htmlFor={`objective-${index}-description`}
                          className='text-sm'
                        >
                        ...
                        <Textarea
                          ...
                          {...register(
                            `learningObjectives.${index}.description`,
                          )}
                        />
              ...
              <div className='p-4 bg-amber-50 rounded-lg border border-amber-200 md:block hidden'>
                <p className='text-sm text-amber-800'>
                  <strong>Tip:</strong> Good learning objectives are specific
                  and measurable. Instead of &quot;learn programming,&quot; try
                  &quot;build a personal website using HTML, CSS, and
                  JavaScript.&quot;
                </p>
              </div>
            </div>
